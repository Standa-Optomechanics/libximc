...
make DISTDIR=$RPM_BUILD_ROOT/.. install-strip
...
* Tue Dec 16 2025 XIMC <8smc4@standa.lt> - 3.0.2
- version bump
- Bug: Fixed a typo in advanced, #86669
- Bug: Fix Python wrapper bug for windows, #125240
- Bug: Corrected names of folders with examples, #126213
- Bug: Documentation corrected, #126215
- Bug: Driver installation fixed, #126682
- Bug: Fixed the example with movement in notebook, #126909
- Feature: Deprecated functions removed, #127560

* Fri Oct 31 2025 XIMC <8smc4@standa.lt> - 3.0.1
- version bump
- Fix Python wrapper bug for windows, #125240
- Update protocol to v20.13

* Tue Oct 07 2025 XIMC <8smc4@standa.lt> - 3.0.0
- version bump
- Feature: The libximc build has been structured, #95282
- Feature: The building of deb packages moved to a separate script, #103605
- Feature: Changes from dev-2.14 added, #121091
- Bug: Fixed xigen behavior, #122813

* Sun Oct 05 2025 XIMC <8smc4@standa.lt> - 2.14.31
- version bump
- No release! Just increment the version before new release.

* Mon Aug 25 2025 XIMC <8smc4@standa.lt> - 2.14.31
- version bump
- Feature: The examples have been tidied up, #86772
- Feature: The building of deb packages moved to a separate script, #103605
- Feature: Protocol version 20.10 has been released, #119790

* Tue Jun 24 2025 XIMC <8smc4@standa.lt> - 2.14.30
- version bump
- Feature: The building of deb packages moved to a separate script, #103605
- Bug: Changed search for controllers in the network, #114892
...
- version bump
- Bug: Fix documentation a little
- Bug: Fix python binding bug with uninitialized structures, #105984
- Bug: Add errcode return while trying to set calb.coeff. A to 0, #91948

* Wed Aug 28 2024 XIMC <8smc4@standa.lt> - 2.14.27
- version bump
- Add pauses into examples, #99322
- Mark USB voltage and current values as deprecated, #103346

* Tue Aug 06 2024 XIMC <8smc4@standa.lt> - 2.14.26
- version bump
- Change README

* Mon Aug 05 2024 XIMC <8smc4@standa.lt> - 2.14.25
- version bump
- Fix PyPI summary bug, #102659

* Wed Jul 17 2024 XIMC <8smc4@standa.lt> - 2.14.24
- version bump
- Change README.md to README.txt in Python Jupyter example
- Improve documentation for joystick_settings and enumerate_devices, #97384
- Update READMEs for examples, #99321
- Add 'Deprecated' note in ximc_fix_usbser_sys documentation, #90338
- Fix testpython.py, #99244
- Add local imports, #95890
- Fix debian related bug of wrong shared objects directory, #99322
- Add pauses in C examples, #99322

* Tue May 28 2024 XIMC <8smc4@standa.lt> - 2.14.23
- version bump
- Bug: Fix enumeration bug, #99039
- Feture: added jupyter readme, #99084
- Bug: Fix indecies bug, #99109

* Tue Apr 23 2024 XIMC <8smc4@standa.lt> - 2.14.22
- version bump
- Bug: fix xi-net bug, #97428

* Tue Mar 05 2024 XIMC <8smc4@standa.lt> - 2.14.21
- version bump
- Add the python binding principles to the README.md
- Feature: Rewrite python examples using new binding, #89826
- Bug: Add integer-comparison support for enums, #92182
- Feature: Add deprecation warning to ximc_fix_usbser_sys, #90338
- Feature: Add instruction for Linux build, #60546

* Thu Dec 28 2023 XIMC <8smc4@standa.lt> - 2.14.20
- version bump
- add new python binding
- fix docs

* Mon Nov 13 2023 XIMC <8smc4@standa.lt> - 2.14.19
- version bump
...
* Tue Sep 12 2023 XIMC <8smc4@standa.lt> - 2.14.18
- version bump
...
* Wed Aug 23 2023 XIMC <8smc4@standa.lt> - 2.14.17
- version bump
- Bug #84285 Incorrect virtual controllers

* Mon Aug 21 2023 XIMC <8smc4@standa.lt> - 2.14.16
- version bump
- Feature #83712 mDrive enumerate enumerate and discovery errors fixed 

* Tue Jul 25 2023 XIMC <8smc4@standa.lt> - 2.14.15
- version bump
- Feature #83712 mDrive enumerate and discovery added

* Thu Jun 22 2023 XIMC <8smc4@standa.lt> - 2.14.14
- version bump
...
* Fri Jan 20 2023 XIMC <8smc4@standa.lt> - 2.14.9
- version bump
- Feature #72852 XIMC-device net discovering added (miniupnpc used)

* Wed Dec 28 2022 XIMC <8smc4@standa.lt> - 2.14.8
- version bump
...
* Wed Nov 09 2022 XIMC <8smc4@standa.lt> - 2.14.7
- version bump
...
* Mon Apr 18 2022 XIMC <8smc4@standa.lt> - 2.14.2
- version bump
...
* Mon Jan 31 2022 XIMC <8smc4@standa.lt> - 2.13.4
- version bump
...
- Bug #53162 Building and running C examples on linux
- Feature #58545 Note the stop command resets the alarm
- Feature #57646 Update the C and Python profiles in the libximc library
- Feature #57131 An example for the BUILDER C++ environment
- Feature #48566 Automatic testing of our python examples

* Wed Jan 26 2022 XIMC <8smc4@standa.lt> - 2.14.1
- version bump
- Feature #53786 Control of adding UDP support to libximc
- Feature #59317 Add tcp support to libximc

* Tue Dec 28 2021 XIMC <8smc4@standa.lt> - 2.14.0
- version bump
- Feature #54792 Change the description of the flags in the protocol
- Feature #56922 Add UDP support to libximc

* Mon Nov 29 2021 XIMC <8smc4@standa.lt> - 2.13.3
- version bump
...
* Wed Sep 08 2021 XIMC <8smc4@standa.lt> - 2.13.2
- version bump
...
* Mon May 24 2021 XIMC <8smc4@standa.lt> - 2.13.1
- version bump
...
* Wed Mar 31 2021 XIMC <8smc4@standa.lt> - 2.13.0
- version bump
...
* Mon Mar 22 2021 XIMC <8smc4@standa.lt> - 2.12.10
- version bump
- Feature #47473 Refine it testpythonprofile and fix the folder structure

* Tue Mar 02 2021 XIMC <8smc4@standa.lt> - 2.12.8
- version bump
...
* Wed Feb 10 2021 XIMC <8smc4@standa.lt> - 2.12.7
- version bump
...
* Fri Jan 22 2021 XIMC <8smc4@standa.lt> - 2.12.6
- version bump
...
* Tue Oct 20 2020 XIMC <8smc4@standa.lt> - 2.12.5
- version bump
...
* Mon Aug 17 2020 XIMC <8smc4@standa.lt> - 2.12.4
- version bump
...
* Thu Aug 17 2017 XIMC <8smc4@standa.lt> - 2.10.2
- version bump

* Wed Jun 21 2017 XIMC <8smc4@standa.lt> - 2.10.1
- version bump
- feature #17319: Protocol 18.1 support


* Thu Jun 15 2017 XIMC <8smc4@standa.lt> - 2.10.0
- version bump
- feature #17221: Protocol 18.0 support

* Thu Mar 09 2017 XIMC <8smc4@standa.lt> - 2.9.8
- version bump
- feature #15152: New motor status flags added

* Tue Feb 21 2017 XIMC <8smc4@standa.lt> - 2.9.7
- version bump
- bug #15050: Updated cryptopp to cmake bindy build

* Wed Feb 15 2017 XIMC <8smc4@standa.lt> - 2.9.6
- version bump
- bug #14953: Hang or segfault in enumerate

* Thu Feb 02 2017 XIMC <8smc4@standa.lt> - 2.9.5
- version bump
- fixed bindy keyfile compatibility

* Thu Dec 15 2016 XIMC <8smc4@standa.lt> - 2.9.4
- version bump

* Thu Nov 17 2016 XIMC <8smc4@standa.lt> - 2.9.3
- version bump
- feature #13036: Protocol 17.2 support

* Mon Mar 28 2016 XIMC <8smc4@standa.lt> - 2.8.8
- version bump
- feature #9963: Option to enter Alarm on ExtIO
- feature #9968: Protocol 16.11 support

* Thu Feb 18 2016 XIMC <8smc4@standa.lt> - 2.9.2
- version bump
- feature #9423: added support for GNVM/SNVM in virtual controllers

* Thu Jan 28 2016 XIMC <8smc4@standa.lt> - 2.9.1
- version bump
- updated libximc to use bindy-sqlite

* Wed Dec 16 2015 XIMC <8smc4@standa.lt> - 2.8.7
- version bump
- bug #8651: Disconnect recovery

* Thu Dec 10 2015 XIMC <8smc4@standa.lt> - 2.9.0
- version bump
- bug #8651: Disconnect recovery
- bug #8714: Memory leak in open_device
- bug #8731: Memory leak on virtual controller open

* Mon Nov 02 2015 XIMC <8smc4@standa.lt> - 2.8.6
- version bump
...
* Tue Sep 29 2015 XIMC <8smc4@standa.lt> - 2.8.5
- version bump
...
* Wed Aug 19 2015 XIMC <8smc4@standa.lt> - 2.8.4
- version bump
- feature #6204: Added wait_for_stop function

* Mon Aug 17 2015 XIMC <8smc4@standa.lt> - 2.8.3
- version bump
- feature #7971: Network enumerate obeys library timeouts now

* Thu Jul 30 2015 XIMC <8smc4@standa.lt> - 2.8.2
- version bump
- feature #7971: Added multithreaded multiserver network enumerate

* Thu Jul 09 2015 XIMC <8smc4@standa.lt> - 2.8.1
- version bump
- feature #7017: Added broadcast discovery option for network controllers

* Thu Jun 04 2015 XIMC <8smc4@standa.lt> - 2.8.0
- version bump

* Mon Jun 01 2015 XIMC <8smc4@standa.lt> - 2.7.8
- version bump
- bug #7694: fix libximc memory allocation error

* Wed May 27 2015 XIMC <8smc4@standa.lt> - 2.7.7
- version bump
- feature #7024: fixed bindy (network controllers)

* Thu May 14 2015 XIMC <8smc4@standa.lt> - 2.7.6
- version bump
- feature #4863: virtual controllers
- feature #7292: binary version changed to 7

* Tue Apr 28 2015 XIMC <8smc4@standa.lt> - 2.7.5
- version bump

* Thu Apr 23 2015 XIMC <8smc4@standa.lt> - 2.7.4
- version bump
- feature #7015: transition to ximc network protocol v1

* Tue Apr 07 2015 XIMC <8smc4@standa.lt> - 2.7.3
- version bump
...
* Tue Mar 17 2015 XIMC <8smc4@standa.lt> - 2.7.2
- version bump
- feature #6738: API changes

* Wed Feb 25 2015 XIMC <8smc4@standa.lt> - 2.7.1
- version bump
- bug #6253: Matlab example fixed

* Fri Feb 13 2015 XIMC <8smc4@standa.lt> - 2.7.0
- version bump
- feature #6006: Bindy support
- bug #6735: Buffering inside libximc

* Tue Feb 10 2015 XIMC <8smc4@standa.lt> - 2.5.1
- version bump

* Tue Sep 02 2014 XIMC <8smc4@standa.lt> - 2.3.2
- version bump
- bug #5691: C# protected memory exception, revised

* Thu Aug 28 2014 XIMC <8smc4@standa.lt> - 2.3.1
- version bump
- bug #5691: C# protected memory exception

* Mon May 26 2014 XIMC <8smc4@standa.lt> - 2.5.0
- version bump
- bug #4624: Profile section deduplication
- feature #4730: Protocol 16.8 support

* Mon Mar 24 2014 XIMC <8smc4@standa.lt> - 2.4.0
- version bump
- bug #4323: Change ASIA command structure
- feature #4687: Add DBGW command

* Mon Jan 27 2014 XIMC <8smc4@standa.lt> - 2.3.0
- version bump
- feature #3508: Multithreading

* Fri Nov 29 2013 XIMC <8smc4@standa.lt> - 2.2.2
- version bump
- bug #4220: Support 64-bit types for LabVIEW

* Tue Nov 19 2013 XIMC <8smc4@standa.lt> - 2.2.1
- version bump
- bug #4143: Fixed synchronization function

* Sat Nov 02 2013 XIMC <8smc4@standa.lt> - 2.2.0
- version bump
- bug #2953: java generator support
- feature #4010: profile assembler update

* Thu Oct 17 2013 XIMC <8smc4@standa.lt> - 2.1.1
- version bump
- bug #3988: Fix typing errors

* Tue Oct 15 2013 XIMC <8smc4@standa.lt> - 2.1.0
- version bump
...
* Tue Sep 24 2013 XIMC <8smc4@standa.lt> - 2.0.9
- version bump
- feature #3785: Merged with protocol 16.4

* Fri Sep 20 2013 XIMC <8smc4@standa.lt> - 2.0.8
- version bump
- bug #3610: Calibration for c#, delphi wrappers
- feature #3499: Documentation with new block tags

* Thu Aug 15 2013 XIMC <8smc4@standa.lt> - 2.0.7
- version bump
...
* Wed Aug 07 2013 XIMC <8smc4@standa.lt> - 2.0.6
- version bump
- bug #3959: _impl in wiki doc
bug #3610: Calibrations for CSharp and Delphi
bug #3573: Readibility of libximc doc
...
* Wed Jul 17 2013 XIMC <8smc4@standa.lt> - 2.0.5
- version bump
...
* Sat Jun 22 2013 XIMC <8smc4@standa.lt> - 2.0.4
- version bump
...
* Sun May 19 2013 XIMC <8smc4@standa.lt> - 2.0.3
- version bump
- bug #1566: Connection loss after a hour of work
- feature #2786: Open devices by serial number

* Mon May 06 2013 XIMC <8smc4@standa.lt> - 2.0.2
- version bump

* Thu May 02 2013 XIMC <8smc4@standa.lt> - 2.0.1
- version bump
- feature #2275: Make a QScript generator
- feature #2450: Support ERRV answers
- feature #2842: Support 64-bit numbers in protocol

* Sun Mar 17 2013 XIMC <8smc4@standa.lt> - 2.0.0
- version bump
- bug #1566: Connection loss after a hour of work
...
* Sun Dec 30 2012 XIMC <8smc4@standa.lt> - 1.7.1
- version bump
...
* Tue Dec 18 2012 XIMC <8smc4@standa.lt> - 1.7.0
- version bump
- bug #2082: Deny multiple port open in OSX
- bug #2091: Trim endlines in log

* Wed Oct 10 2012 XIMC <8smc4@standa.lt> - 1.6.9
- version bump

* Fri Oct 05 2012 XIMC <8smc4@standa.lt> - 1.6.8
- version bump
...
* Wed Aug 01 2012 XIMC <8smc4@standa.lt> - 1.6.7
- version bump
...
* Tue Jul 31 2012 XIMC <8smc4@standa.lt> - 1.6.6
- version bump

* Wed Jul 25 2012 XIMC <8smc4@standa.lt> - 1.6.5
- version bump
...
* Fri Jun 22 2012 XIMC <8smc4@standa.lt> - 1.6.4
- version bump

* Wed Jun 13 2012 XIMC <8smc4@standa.lt> - 1.6.3
- version bump
...
* Wed May 16 2012 XIMC <8smc4@standa.lt> - 1.6.2
- Version bump
- bug #1345: 1.60 bugs - missing functions
- bug #1346: 1.60 bugs - problems with commands

* Sat May 12 2012 XIMC <8smc4@standa.lt> - 1.6.1
- Version bump
...
* Sat May 05 2012 XIMC <8smc4@standa.lt> - 1.6.0
- Version 1.6.0
- major API break
- feature #966: Automatic library generator based on protocol definition file

* Thu Apr 26 2012 XIMC <8smc4@standa.lt> - 1.5.9
- Version 1.5.9
...
* Tue Feb 21 2012 XIMC <8smc4@standa.lt> - 1.5.8
- Version 1.5.8
- Beta build 3

* Tue Feb 21 2012 XIMC <8smc4@standa.lt> - 1.5.7
- Version 1.5.7
- Beta build 2

* Sun Feb 19 2012 XIMC <8smc4@standa.lt> - 1.5.6
- Version 1.5.6
- Beta build 1

* Sat Oct 01 2011 XIMC <8smc4@standa.lt> - 1.5.5
- Version 1.5.5
- Fix for the UART problem with some XISM controllers

* Fri Sep 30 2011 XIMC <8smc4@standa.lt> - 1.5.4
- Version 1.5.4
...
* Sat Aug 20 2011 XIMC <8smc4@standa.lt> - 1.5.3
- Version 1.5.3
...
* Wed Mar 09 2011 XIMC <8smc4@standa.lt> - 1.5.0
- Version 1.5.0
...
* Sun Dec 26 2010 XIMC <8smc4@standa.lt> - 1.4.1
- Version 1.4.1
- feature #425: linux version doesn't query ttyACM ttys

* Wed Nov 24 2010 XIMC <8smc4@standa.lt> - 1.4.0
- Version 1.4.0
- feature #358: Protocol v12 support

* Sat Oct 16 2010 XIMC <8smc4@standa.lt> - 1.3.0
- Version 1.3.0
- feature #94: Visual Basic support

* Wed Sep 29 2010 XIMC <8smc4@standa.lt> - 1.2.0
- Version 1.2.0
- bug #286: hang while accessing two different devices

* Fri Apr 02 2010 XIMC <8smc4@standa.lt> - 1.1.1
- Version 1.1.1
- bug #267: firmware update doesn't work
- feature #264: development kit

* Fri Feb 19 2010 XIMC <8smc4@standa.lt> - 1.1.0
- Version 1.1.0
- bug #34: COM port
...
* Sun Dec 12 2009 XIMC <8smc4@standa.lt> - 1.0.0
- Version 1.0.0
...
* Sat Aug 15 2009 XIMC <8smc4@standa.lt> - 0.9.0
- Version 0.9.0
...
* Thu Jul 23 2009 XIMC <8smc4@standa.lt> - 0.8.0
- Version 0.8.0
...
* Wed Jul 08 2009 XIMC <8smc4@standa.lt> - 0.7.0
- Version 0.7.0
...
* Tue Jun 30 2009 XIMC <8smc4@standa.lt> - 0.6.0
- Version 0.6.0
...
* Thu May 21 2009 XIMC <8smc4@standa.lt> - 0.5.0
- Version 0.5.0
- Updated documentation
- Fix memory problem
- Improve compatibility with C++ on windows

* Wed May 06 2009 XIMC <8smc4@standa.lt> - 0.4.0
- Version 0.4.0
- Added documentation

* Sat Apr 04 2009 XIMC <8smc4@standa.lt>
- Added deb and rpm packages building
- Mac OS X library is private framework now
- Add version numbers in win32 version

* Thu Apr 02 2009 XIMC <8smc4@standa.lt>
