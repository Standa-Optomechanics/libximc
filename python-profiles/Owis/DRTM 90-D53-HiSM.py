def set_profile_DRTM_90_D53_HiSM(lib, id):
    ...
    feedback_settings.FeedbackFlags = FeedbackFlags_.FEEDBACK_ENC_TYPE_AUTO
    ...
    power_settings.PowerFlags = PowerFlags_.POWER_REDUCT_ENABLED
    ...
    class BorderFlags_:
        ...
        BORDER_STOP_LEFT = 2
        BORDER_IS_ENCODER = 1
    edges_settings.BorderFlags = BorderFlags_.BORDERS_SWAP_MISSET_DETECTION
    class EnderFlags_:
    ...
    control_settings.uMaxSpeed[0] = 48
    control_settings.uMaxSpeed[1] = 48
    control_settings.uMaxSpeed[2] = 49
    control_settings.uMaxSpeed[3] = 48
    control_settings.uMaxSpeed[4] = 48
    ...
    class Flags_:
        ...
        CONTROL_MODE_JOY = 1
        CONTROL_MODE_OFF = 0
    control_settings.Flags = Flags_.CONTROL_MODE_OFF
    ...
    class CTPFlags_:
        ...
        CTP_BASE = 2
        CTP_ENABLED = 1
    ctp_settings.CTPFlags = CTPFlags_.CTP_ALARM_ON_ERROR
