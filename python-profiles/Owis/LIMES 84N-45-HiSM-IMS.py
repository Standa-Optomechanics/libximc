def set_profile_LIMES_84N_45_HiSM_IMS(lib, id):
    ...
    class BorderFlags_:
        ...
        BORDER_STOP_LEFT = 2
        BORDER_IS_ENCODER = 1
    edges_settings.BorderFlags = BorderFlags_.BORDERS_SWAP_MISSET_DETECTION | BorderFlags_.BORDER_STOP_RIGHT | BorderFlags_.BORDER_STOP_LEFT | BorderFlags_.BORDER_IS_ENCODER
    class EnderFlags_:
