def set_profile_8MR191_30_4209_E4(lib, id):
    ...
    class CTPFlags_:
        ...
        CTP_BASE = 2
        CTP_ENABLED = 1
    ctp_settings.CTPFlags = CTPFlags_.CTP_ERROR_CORRECTION | CTPFlags_.CTP_BASE | CTPFlags_.CTP_ENABLED
    ...
    stage_information.PartNumber = bytes([56, 77, 82, 49, 57, 49, 45, 51, 48, 45, 52, 50, 48, 57, 45, 69, 52, 0, 0, 0, 0, 0, 0, 0])
