def set_profile_8MT60_200(lib, id):
    ...
    stage_information.PartNumber = bytes([56, 77, 84, 54, 48, 45, 50, 48, 48, 0, 66, 83, 49, 0, 69, 110, 49, 0, 0, 0, 0, 69, 65, 83])
    ...
    motor_information.Manufacturer = bytes([77, 111, 116, 105, 111, 110, 32, 67, 111, 110, 116, 114, 111, 108, 32, 80])
