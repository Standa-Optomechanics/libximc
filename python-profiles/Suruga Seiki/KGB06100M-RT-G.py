def set_profile_KGB06100M_RT_G(lib, id):
    ...
    control_settings.uMaxSpeed[0] = 214
    control_settings.uMaxSpeed[1] = 39
    control_settings.uMaxSpeed[2] = 169
    control_settings.uMaxSpeed[3] = 255
    control_settings.uMaxSpeed[4] = 225
    ...
    class CTPFlags_:
        ...
        CTP_BASE = 2
        CTP_ENABLED = 1
    ctp_settings.CTPFlags = CTPFlags_.REV_SENS_INV | CTPFlags_.CTP_ALARM_ON_ERROR
