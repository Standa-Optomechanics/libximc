def set_profile_RST120AK_DE50T10A(lib, id):
    ...
    class FeedbackFlags_:
        ...
        FEEDBACK_ENC_ADAPTIVE_HOLDING = 2
    ...
    class Flags_:
        ...
        BRAKING_OVERVOLTAGE_PROTECTION = 32
    ...
    stage_information.PartNumber = bytes([82, 83, 84, 49, 50, 48, 65, 75, 45, 68, 69, 53, 48, 84, 49, 48, 65, 0, 48, 0, 0, 0, 0, 83])
    ...
    motor_information.Manufacturer = bytes([90, 97, 98, 101, 114, 0, 32, 67, 111, 110, 116, 114, 111, 108, 32, 80])
