...
#define LNR25ZFS_BUILDER_VERSION_BUGFIX 16
#define LNR25ZFS_BUILDER_VERSION_SUFFIX ""
#define LNR25ZFS_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_LNR25ZFS(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {76, 78, 82, 50, 53, 90, 70, 83, 0, 45, 49, 0, 83, 83, 52, 51, 0, 53, 48, 0, 0, 0, 0, 83};
