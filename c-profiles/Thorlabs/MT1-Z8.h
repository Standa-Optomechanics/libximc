...
#define MT1_Z8_BUILDER_VERSION_BUGFIX 16
#define MT1_Z8_BUILDER_VERSION_SUFFIX ""
#define MT1_Z8_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_MT1_Z8(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {77, 84, 49, 45, 90, 56, 0, 83, 0, 45, 49, 0, 83, 83, 52, 51, 0, 53, 48, 0, 0, 0, 0, 83};
