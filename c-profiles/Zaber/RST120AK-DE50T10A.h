...
#define RST120AK_DE50T10A_BUILDER_VERSION_MINOR  9
#define RST120AK_DE50T10A_BUILDER_VERSION_BUGFIX 16
#define RST120AK_DE50T10A_BUILDER_VERSION_SUFFIX ""
#define RST120AK_DE50T10A_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_RST120AK_DE50T10A(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {82, 83, 84, 49, 50, 48, 65, 75, 45, 68, 69, 53, 48, 84, 49, 48, 65, 0, 48, 0, 0, 0, 0, 83};
  ...
  const int8_t motor_information_Manufacturer_temp[16] = {90, 97, 98, 101, 114, 0, 32, 67, 111, 110, 116, 114, 111, 108, 32, 80};
