...
#define RST120AK_E03T3A_BUILDER_VERSION_MINOR  9
#define RST120AK_E03T3A_BUILDER_VERSION_BUGFIX 16
#define RST120AK_E03T3A_BUILDER_VERSION_SUFFIX ""
#define RST120AK_E03T3A_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_RST120AK_E03T3A(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {82, 83, 84, 49, 50, 48, 65, 75, 45, 69, 48, 51, 84, 51, 65, 0, 65, 0, 48, 0, 0, 0, 0, 83};
