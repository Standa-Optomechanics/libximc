#ifndef __RST120AK_E03T3A
#define __RST120AK_E03T3A
...
#define RST120AK_E03T3A_BUILDER_VERSION_MAJOR  0
#define RST120AK_E03T3A_BUILDER_VERSION_MINOR  10
#define RST120AK_E03T3A_BUILDER_VERSION_BUGFIX 26
#define RST120AK_E03T3A_BUILDER_VERSION_SUFFIX ""
#define RST120AK_E03T3A_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_RST120AK_E03T3A(device_t id)
{
  ...
  feedback_settings.CountsPerTurn = 800;
  ...
  edges_settings.LeftBorder = 600;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 137400;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {82, 83, 84, 49, 50, 48, 65, 75, 45, 69, 48, 51, 84, 51, 65, 0, 0, 0, 0, 0, 0, 0, 0, 0};
