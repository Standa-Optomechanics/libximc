...
#define LAC10A_T4A_BUILDER_VERSION_MINOR  9
#define LAC10A_T4A_BUILDER_VERSION_BUGFIX 16
#define LAC10A_T4A_BUILDER_VERSION_SUFFIX ""
#define LAC10A_T4A_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_LAC10A_T4A(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {76, 65, 67, 49, 48, 65, 45, 84, 52, 65, 0, 0, 83, 83, 52, 51, 0, 53, 48, 0, 0, 0, 0, 83};
  ...
  stage_settings.LeadScrewPitch = 0.30480000376701355;
