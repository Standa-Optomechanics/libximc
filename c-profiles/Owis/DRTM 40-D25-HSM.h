#ifndef __DRTM 40_D25_HSM
#define __DRTM 40_D25_HSM
...
#define DRTM 40_D25_HSM_BUILDER_VERSION_MAJOR  0
#define DRTM 40_D25_HSM_BUILDER_VERSION_MINOR  10
#define DRTM 40_D25_HSM_BUILDER_VERSION_BUGFIX 26
#define DRTM 40_D25_HSM_BUILDER_VERSION_SUFFIX ""
#define DRTM 40_D25_HSM_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_DRTM 40_D25_HSM(device_t id)
{
  ...
  home_settings.FastHome = 630;
  home_settings.uFastHome = 220;
  home_settings.SlowHome = 19;
  home_settings.uSlowHome = 205;
  home_settings.HomeDelta = 1;
  home_settings.uHomeDelta = 67;
  ...
  move_settings.Speed = 1261;
  move_settings.uSpeed = 243;
  move_settings.Accel = 631;
  move_settings.Decel = 1262;
  move_settings.AntiplaySpeed = 49;
  move_settings.uAntiplaySpeed = 204;
  ...
  engine_settings.NomSpeed = 3154;
  engine_settings.uNomSpeed = 76;
  ...
  edges_settings.RightBorder = 600;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {49, 48, 48, 48, 48, 0, 0, 0, 0, 0};
