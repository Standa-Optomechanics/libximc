#ifndef __LTM_80P_145_MIDS
#define __LTM_80P_145_MIDS
...
#define LTM_80P_145_MIDS_BUILDER_VERSION_MAJOR  0
#define LTM_80P_145_MIDS_BUILDER_VERSION_MINOR  9
#define LTM_80P_145_MIDS_BUILDER_VERSION_BUGFIX 16
#define LTM_80P_145_MIDS_BUILDER_VERSION_SUFFIX ""
#define LTM_80P_145_MIDS_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_LTM_80P_145_MIDS(device_t id)
{
  ...
  feedback_settings.CountsPerTurn = 8000;
  ...
  engine_settings.Antiplay = 20000;
  ...
  edges_settings.LeftBorder = 21000;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 1123000;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {76, 84, 77, 45, 56, 48, 80, 45, 49, 52, 53, 45, 77, 73, 68, 83, 0, 52, 48, 68, 45, 69, 65, 83};
  ...
  stage_settings.TravelRange = 145;
