#ifndef __LTM_80F_210_MSM
#define __LTM_80F_210_MSM
...
#define LTM_80F_210_MSM_BUILDER_VERSION_MAJOR  0
#define LTM_80F_210_MSM_BUILDER_VERSION_MINOR  9
#define LTM_80F_210_MSM_BUILDER_VERSION_BUGFIX 16
#define LTM_80F_210_MSM_BUILDER_VERSION_SUFFIX ""
#define LTM_80F_210_MSM_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_LTM_80F_210_MSM(device_t id)
{
  ...
  edges_settings.LeftBorder = -6950;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 32950;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {76, 84, 77, 45, 56, 48, 70, 45, 50, 49, 48, 45, 77, 83, 77, 0, 0, 52, 48, 68, 45, 69, 65, 83};
