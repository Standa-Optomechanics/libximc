...
#define LINPOS S_BUILDER_VERSION_MAJOR  0
#define LINPOS S_BUILDER_VERSION_MINOR  10
#define LINPOS S_BUILDER_VERSION_BUGFIX 26
#define LINPOS S_BUILDER_VERSION_SUFFIX ""
#define LINPOS S_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_LINPOS S(device_t id)
{
  ...
  engine_settings.NomSpeed = 1500075;
  ...
  edges_settings.RightBorder = 5333600;
