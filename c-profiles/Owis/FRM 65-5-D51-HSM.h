#ifndef __FRM 65_5_D51_HSM
#define __FRM 65_5_D51_HSM
...
#define FRM 65_5_D51_HSM_BUILDER_VERSION_MAJOR  0
#define FRM 65_5_D51_HSM_BUILDER_VERSION_MINOR  10
#define FRM 65_5_D51_HSM_BUILDER_VERSION_BUGFIX 26
#define FRM 65_5_D51_HSM_BUILDER_VERSION_SUFFIX ""
#define FRM 65_5_D51_HSM_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_FRM 65_5_D51_HSM(device_t id)
{
  ...
  home_settings.FastHome = 225;
  home_settings.uFastHome = 200;
  home_settings.SlowHome = 0;
  home_settings.uSlowHome = 0;
  home_settings.HomeDelta = 1;
  home_settings.uHomeDelta = 33;
  ...
  move_settings.Speed = 1129;
  move_settings.uSpeed = 0;
  move_settings.Accel = 564;
  move_settings.Decel = 1129;
  move_settings.AntiplaySpeed = 0;
  ...
  edges_settings.RightBorder = 406;
  edges_settings.uRightBorder = 104;
  ...
  sync_in_settings.Speed = 533;
  sync_in_settings.uSpeed = 92;
  ...
  control_settings.MaxSpeed[0] = 0;
  control_settings.MaxSpeed[1] = 0;
  control_settings.MaxSpeed[2] = 133;
  control_settings.MaxSpeed[3] = 933;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {0, 0, 87, 97, 128, 0, 0, 0, 0, 0};
  ...
  control_settings.DeltaPosition = 10001;
  control_settings.uDeltaPosition = -128;
