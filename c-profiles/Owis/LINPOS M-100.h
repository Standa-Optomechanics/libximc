#ifndef __LINPOS M_100
#define __LINPOS M_100
...
#define LINPOS M_100_BUILDER_VERSION_MAJOR  0
#define LINPOS M_100_BUILDER_VERSION_MINOR  10
#define LINPOS M_100_BUILDER_VERSION_BUGFIX 26
#define LINPOS M_100_BUILDER_VERSION_SUFFIX ""
#define LINPOS M_100_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_LINPOS M_100(device_t id)
{
  ...
  home_settings.FastHome = 10000;
  home_settings.uFastHome = 128;
  home_settings.SlowHome = 6;
  home_settings.uSlowHome = 0;
  home_settings.HomeDelta = 133340;
  ...
  move_settings.Speed = 20001;
  move_settings.uSpeed = 0;
  move_settings.Accel = 10001;
  move_settings.Decel = 20001;
  move_settings.AntiplaySpeed = 14;
  ...
  engine_settings.NomSpeed = 1900095;
  ...
  edges_settings.RightBorder = 13334000;
  ...
  sync_in_settings.Speed = 150;
  sync_in_settings.uSpeed = 2;
  ...
  control_settings.MaxSpeed[1] = 2;
  control_settings.MaxSpeed[2] = 30;
  control_settings.MaxSpeed[3] = 300;
  control_settings.MaxSpeed[4] = 3000;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {0, 0, 0, 4, 38, 0, 0, 0, 0, 0};
  ...
  control_settings.DeltaPosition = 200010;
