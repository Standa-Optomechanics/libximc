#ifndef __IBM 65_D0_35_HISM
#define __IBM 65_D0_35_HISM
...
#define IBM 65_D0_35_HISM_BUILDER_VERSION_MAJOR  0
#define IBM 65_D0_35_HISM_BUILDER_VERSION_MINOR  10
#define IBM 65_D0_35_HISM_BUILDER_VERSION_BUGFIX 26
#define IBM 65_D0_35_HISM_BUILDER_VERSION_SUFFIX ""
#define IBM 65_D0_35_HISM_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_IBM 65_D0_35_HiSM(device_t id)
{
  ...
  home_settings.FastHome = 17;
  home_settings.uFastHome = 92;
  home_settings.SlowHome = 20;
  home_settings.uSlowHome = 23;
  home_settings.HomeDelta = 25;
  ...
  move_settings.Speed = 17;
  move_settings.uSpeed = 92;
  move_settings.Accel = 9;
  move_settings.Decel = 17;
  move_settings.AntiplaySpeed = 50;
  move_settings.uAntiplaySpeed = 25;
  ...
  engine_settings.NomCurrent = 450;
  engine_settings.NomSpeed = 34;
  engine_settings.uNomSpeed = 184;
  engine_settings.EngineFlags = IMPORTED PROJECT_ENGINE_LIMIT_RPM | IMPORTED PROJECT_ENGINE_ACCEL_ON;
  ...
  edges_settings.BorderFlags = IMPORTED PROJECT_BORDERS_SWAP_MISSET_DETECTION | IMPORTED PROJECT_BORDER_STOP_RIGHT | IMPORTED PROJECT_BORDER_STOP_LEFT;
  edges_settings.EnderFlags = 0;
  edges_settings.LeftBorder = 0;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 6200;
  ...
  sync_in_settings.Speed = 499;
  sync_in_settings.uSpeed = 248;
  ...
  control_settings.MaxSpeed[2] = 99;
  control_settings.MaxSpeed[3] = 999;
  control_settings.MaxSpeed[4] = 10000;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {61, 236, 242, 240, 27, 0, 0, 0, 0, 0};
  ...
  control_settings.DeltaPosition = 10000;
  control_settings.uDeltaPosition = 27;
  ...
  ctp_settings.CTPFlags = IMPORTED PROJECT_CTP_ALARM_ON_ERROR;
