#ifndef __DMT 40_D20_HISM
#define __DMT 40_D20_HISM
...
#define DMT 40_D20_HISM_BUILDER_VERSION_MAJOR  0
#define DMT 40_D20_HISM_BUILDER_VERSION_MINOR  10
#define DMT 40_D20_HISM_BUILDER_VERSION_BUGFIX 26
#define DMT 40_D20_HISM_BUILDER_VERSION_SUFFIX ""
#define DMT 40_D20_HISM_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_DMT 40_D20_HiSM(device_t id)
{
  ...
  move_settings.Speed = 25;
  move_settings.uSpeed = 0;
  move_settings.Accel = 13;
  move_settings.Decel = 25;
  ...
  edges_settings.RightBorder = 18000;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {51, 51, 51, 51, 51, 0, 0, 0, 0, 0};
  ...
  control_settings.uDeltaPosition = 51;
