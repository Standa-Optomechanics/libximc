#ifndef __LTM_80M_270_MSM
#define __LTM_80M_270_MSM
...
#define LTM_80M_270_MSM_BUILDER_VERSION_MAJOR  0
#define LTM_80M_270_MSM_BUILDER_VERSION_MINOR  9
#define LTM_80M_270_MSM_BUILDER_VERSION_BUGFIX 16
#define LTM_80M_270_MSM_BUILDER_VERSION_SUFFIX ""
#define LTM_80M_270_MSM_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_LTM_80M_270_MSM(device_t id)
{
  ...
  edges_settings.LeftBorder = -6650;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 44650;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {76, 84, 77, 45, 56, 48, 77, 45, 50, 55, 48, 45, 77, 83, 77, 0, 0, 52, 48, 68, 45, 69, 65, 83};
