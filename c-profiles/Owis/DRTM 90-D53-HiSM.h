#ifndef __DRTM 90_D53_HISM
#define __DRTM 90_D53_HISM
...
#define DRTM 90_D53_HISM_BUILDER_VERSION_MAJOR  0
#define DRTM 90_D53_HISM_BUILDER_VERSION_MINOR  10
#define DRTM 90_D53_HISM_BUILDER_VERSION_BUGFIX 26
#define DRTM 90_D53_HISM_BUILDER_VERSION_SUFFIX ""
#define DRTM 90_D53_HISM_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_DRTM 90_D53_HiSM(device_t id)
{
  ...
  home_settings.FastHome = 805;
  home_settings.uFastHome = 70;
  home_settings.SlowHome = 19;
  home_settings.uSlowHome = 204;
  home_settings.HomeDelta = 2;
  home_settings.uHomeDelta = 77;
  ...
  move_settings.Speed = 1610;
  move_settings.uSpeed = 140;
  move_settings.Accel = 805;
  move_settings.Decel = 1611;
  move_settings.AntiplaySpeed = 49;
  move_settings.uAntiplaySpeed = 205;
  ...
  engine_settings.NomSpeed = 3221;
  engine_settings.uNomSpeed = 24;
  ...
  edges_settings.BorderFlags = IMPORTED PROJECT_BORDERS_SWAP_MISSET_DETECTION;
  edges_settings.EnderFlags = 0;
  edges_settings.LeftBorder = 0;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 828;
  edges_settings.uRightBorder = 72;
  ...
  control_settings.MaxSpeed[1] = 10;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {48, 48, 49, 48, 48, 0, 0, 0, 0, 0};
  ...
  control_settings.uDeltaPosition = 48;
