#ifndef __LINPOS M_300
#define __LINPOS M_300
...
#define LINPOS M_300_BUILDER_VERSION_MAJOR  0
#define LINPOS M_300_BUILDER_VERSION_MINOR  10
#define LINPOS M_300_BUILDER_VERSION_BUGFIX 26
#define LINPOS M_300_BUILDER_VERSION_SUFFIX ""
#define LINPOS M_300_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_LINPOS M_300(device_t id)
{
  ...
  edges_settings.RightBorder = 40002000;
  ...
  control_settings.MaxSpeed[2] = 40;
  control_settings.MaxSpeed[3] = 320;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {0, 0, 1, 4, 38, 0, 0, 0, 0, 0};
