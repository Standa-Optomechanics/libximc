...
#define 8MTLF75XY_BUILDER_VERSION_MINOR  9
#define 8MTLF75XY_BUILDER_VERSION_BUGFIX 16
#define 8MTLF75XY_BUILDER_VERSION_SUFFIX ""
#define 8MTLF75XY_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MTLF75XY(device_t id)
{
  ...
  pid_settings.KdU = 0;
  pid_settings.Kpf = 9;
  pid_settings.Kif = 0.00044999999227002263;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 76, 70, 55, 53, 88, 89, 0, 48, 45, 76, 69, 110, 49, 45, 53, 48, 0, 0, 0, 0, 83};
