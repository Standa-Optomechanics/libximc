...
#define 8MVT70_13_1_BUILDER_VERSION_BUGFIX 16
#define 8MVT70_13_1_BUILDER_VERSION_SUFFIX ""
#define 8MVT70_13_1_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MVT70_13_1(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 86, 84, 55, 48, 45, 49, 51, 45, 49, 0, 83, 83, 52, 51, 0, 53, 48, 0, 0, 0, 0, 83};
