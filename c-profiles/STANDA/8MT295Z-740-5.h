...
#define 8MT295Z_740_5_BUILDER_VERSION_BUGFIX 16
#define 8MT295Z_740_5_BUILDER_VERSION_SUFFIX ""
#define 8MT295Z_740_5_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MT295Z_740_5(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 50, 57, 53, 90, 45, 55, 52, 48, 45, 53, 0, 53, 0, 68, 67, 0, 0, 0, 69, 65, 83};
