...
#define 8MTF2_BUILDER_VERSION_BUGFIX 16
#define 8MTF2_BUILDER_VERSION_SUFFIX ""
#define 8MTF2_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MTF2(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 70, 50, 0, 53, 76, 83, 49, 0, 0, 45, 77, 69, 110, 52, 0, 49, 48, 48, 0, 65, 83};
