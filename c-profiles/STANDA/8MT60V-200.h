...
#define 8MT60V_200_BUILDER_VERSION_BUGFIX 16
#define 8MT60V_200_BUILDER_VERSION_SUFFIX ""
#define 8MT60V_200_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MT60V_200(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 54, 48, 86, 45, 50, 48, 48, 0, 83, 49, 0, 69, 110, 49, 0, 0, 0, 0, 69, 65, 83};
