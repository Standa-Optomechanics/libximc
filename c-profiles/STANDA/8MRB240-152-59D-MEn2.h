#ifndef __8MRB240_152_59D_MEN2
#define __8MRB240_152_59D_MEN2
...
#define 8MRB240_152_59D_MEN2_BUILDER_VERSION_MAJOR  0
#define 8MRB240_152_59D_MEN2_BUILDER_VERSION_MINOR  10
#define 8MRB240_152_59D_MEN2_BUILDER_VERSION_BUGFIX 26
#define 8MRB240_152_59D_MEN2_BUILDER_VERSION_SUFFIX ""
#define 8MRB240_152_59D_MEN2_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_8MRB240_152_59D_MEn2(device_t id)
{
  ...
  edges_settings.LeftBorder = -38958;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = -958;
  ...
  ctp_settings.CTPFlags = IMPORTED PROJECT_CTP_ERROR_CORRECTION | IMPORTED PROJECT_REV_SENS_INV | IMPORTED PROJECT_CTP_ENABLED;
  ...
  emf_settings.L = 0.0130000002682209;
  emf_settings.R = 2.59999990463257;
  emf_settings.Km = 0.015599999576807;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 66, 50, 52, 48, 45, 49, 53, 50, 45, 53, 57, 68, 45, 77, 69, 110, 50, 0, 0, 0, 0};
