#ifndef __8MLAOM_600_100_MEN2
#define __8MLAOM_600_100_MEN2
...
#define 8MLAOM_600_100_MEN2_BUILDER_VERSION_MAJOR  0
#define 8MLAOM_600_100_MEN2_BUILDER_VERSION_MINOR  10
#define 8MLAOM_600_100_MEN2_BUILDER_VERSION_BUGFIX 26
#define 8MLAOM_600_100_MEN2_BUILDER_VERSION_SUFFIX ""
#define 8MLAOM_600_100_MEN2_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_8MLAOM_600_100_MEn2(device_t id)
{
  ...
  move_settings.Speed = 90;
  move_settings.uSpeed = 0;
  move_settings.Accel = 90;
  move_settings.Decel = 180;
  move_settings.AntiplaySpeed = 5;
  ...
  edges_settings.RightBorder = 96000;
  ...
  control_settings.MaxSpeed[0] = 90;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 76, 65, 79, 77, 45, 54, 48, 48, 45, 49, 48, 48, 45, 77, 69, 110, 50, 0, 0, 0, 0, 0};
