#ifndef __8MRLP80_6_LEN2_100
#define __8MRLP80_6_LEN2_100
...
#define 8MRLP80_6_LEN2_100_BUILDER_VERSION_MAJOR  0
#define 8MRLP80_6_LEN2_100_BUILDER_VERSION_MINOR  10
#define 8MRLP80_6_LEN2_100_BUILDER_VERSION_BUGFIX 26
#define 8MRLP80_6_LEN2_100_BUILDER_VERSION_SUFFIX ""
#define 8MRLP80_6_LEN2_100_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_8MRLP80_6_LEn2_100(device_t id)
{
  ...
  feedback_settings.FeedbackFlags = IMPORTED PROJECT_FEEDBACK_ENC_TYPE_DIFFERENTIAL | IMPORTED PROJECT_FEEDBACK_ENC_TYPE_AUTO;
  ...
  home_settings.HomeFlags = IMPORTED PROJECT_HOME_STOP_SECOND_REV | IMPORTED PROJECT_HOME_STOP_FIRST_REV | IMPORTED PROJECT_HOME_DIR_SECOND;
  ...
  engine_settings.Antiplay = 160000;
  ...
  pid_settings.Kif = 0.08;
  pid_settings.Kdf = 0.8;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 76, 80, 56, 48, 45, 54, 45, 76, 69, 110, 50, 45, 49, 48, 48, 0, 0, 0, 0, 0, 0};
  ...
  gear_settings.RatedInputSpeed = 500;
