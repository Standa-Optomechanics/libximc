...
#define 8MR190_2_DCE_BUILDER_VERSION_BUGFIX 16
#define 8MR190_2_DCE_BUILDER_VERSION_SUFFIX ""
#define 8MR190_2_DCE_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MR190_2_DCE(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 49, 57, 48, 45, 50, 45, 68, 67, 69, 0, 0, 77, 69, 110, 49, 0, 68, 45, 69, 65, 83};
