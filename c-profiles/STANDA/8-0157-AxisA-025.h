#ifndef __8_0157_AXISA_025
#define __8_0157_AXISA_025
...
#define 8_0157_AXISA_025_BUILDER_VERSION_MAJOR  0
#define 8_0157_AXISA_025_BUILDER_VERSION_MINOR  10
#define 8_0157_AXISA_025_BUILDER_VERSION_BUGFIX 26
#define 8_0157_AXISA_025_BUILDER_VERSION_SUFFIX ""
#define 8_0157_AXISA_025_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_8_0157_AxisA_025(device_t id)
{
  ...
  home_settings.HomeFlags = IMPORTED PROJECT_HOME_USE_FAST | IMPORTED PROJECT_HOME_STOP_SECOND_REV | IMPORTED PROJECT_HOME_STOP_FIRST_REV | IMPORTED PROJECT_HOME_DIR_SECOND;
  ...
  engine_settings.Antiplay = 155904000;
  ...
  power_settings.PowerFlags = IMPORTED PROJECT_POWER_SMOOTH_CURRENT;
  ...
  edges_settings.LeftBorder = 104000;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 4056000;
  ...
  brake_settings.BrakeFlags = IMPORTED PROJECT_BRAKE_ENG_PWROFF | IMPORTED PROJECT_BRAKE_ENABLED;
  ...
  ctp_settings.CTPFlags = IMPORTED PROJECT_CTP_ERROR_CORRECTION | IMPORTED PROJECT_REV_SENS_INV;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 45, 48, 49, 53, 55, 45, 65, 120, 105, 115, 65, 45, 48, 50, 53, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  accessories_settings.MBSettings = IMPORTED PROJECT_MB_AVAILABLE;
