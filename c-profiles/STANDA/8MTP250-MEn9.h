#ifndef __8MTP250_MEN9
#define __8MTP250_MEN9
...
#define 8MTP250_MEN9_BUILDER_VERSION_MAJOR  0
#define 8MTP250_MEN9_BUILDER_VERSION_MINOR  10
#define 8MTP250_MEN9_BUILDER_VERSION_BUGFIX 26
#define 8MTP250_MEN9_BUILDER_VERSION_SUFFIX ""
#define 8MTP250_MEN9_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_8MTP250_MEn9(device_t id)
{
  ...
  engine_settings.Antiplay = 39740;
  ...
  edges_settings.LeftBorder = 1748800400;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = -2147483648;
  edges_settings.uRightBorder = -255;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {128, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 83, 48, 48, 86, 45, 50, 53, 45, 86, 83, 83, 52, 51, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  const int8_t stage_settings_Units_temp[8] = {109, 109, 0, 0, 0, 0, 0, 0};
