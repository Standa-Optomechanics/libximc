...
#define 8MID30_15_H_BUILDER_VERSION_BUGFIX 16
#define 8MID30_15_H_BUILDER_VERSION_SUFFIX ""
#define 8MID30_15_H_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MID30_15_H(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 51, 48, 45, 49, 46, 53, 45, 72, 0, 0, 53, 0, 0, 52, 48, 68, 45, 69, 65, 83};
