...
#define 8MT173V_25DCE_BUILDER_VERSION_BUGFIX 16
#define 8MT173V_25DCE_BUILDER_VERSION_SUFFIX ""
#define 8MT173V_25DCE_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MT173V_25DCE(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 55, 51, 86, 45, 50, 53, 68, 67, 69, 0, 52, 50, 0, 51, 0, 0, 0, 69, 65, 83};
