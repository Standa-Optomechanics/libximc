...
#define 8MKVDOM_1_BUILDER_VERSION_BUGFIX 16
#define 8MKVDOM_1_BUILDER_VERSION_SUFFIX ""
#define 8MKVDOM_1_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MKVDOM_1(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 75, 86, 68, 79, 77, 45, 49, 0, 0, 0, 82, 0, 53, 0, 0, 52, 48, 68, 45, 69, 65, 83};
