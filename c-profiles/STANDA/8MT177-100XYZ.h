...
#define 8MT177_100XYZ_BUILDER_VERSION_BUGFIX 16
#define 8MT177_100XYZ_BUILDER_VERSION_SUFFIX ""
#define 8MT177_100XYZ_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MT177_100XYZ(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 55, 55, 45, 49, 48, 48, 88, 89, 90, 0, 89, 90, 0, 0, 0, 0, 0, 69, 65, 83};
