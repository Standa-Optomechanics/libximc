...
#define 8MBM57_2_BUILDER_VERSION_BUGFIX 16
#define 8MBM57_2_BUILDER_VERSION_SUFFIX ""
#define 8MBM57_2_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MBM57_2(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 66, 77, 53, 55, 45, 50, 0, 50, 0, 52, 55, 0, 53, 0, 0, 52, 48, 68, 45, 69, 65, 83};
