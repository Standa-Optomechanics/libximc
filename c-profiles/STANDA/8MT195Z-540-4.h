...
#define 8MT195Z_540_4_BUILDER_VERSION_BUGFIX 16
#define 8MT195Z_540_4_BUILDER_VERSION_SUFFIX ""
#define 8MT195Z_540_4_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MT195Z_540_4(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 57, 53, 90, 45, 53, 52, 48, 45, 52, 0, 53, 0, 68, 67, 0, 0, 0, 69, 65, 83};
