#ifndef __KGB06100M_RT_G
#define __KGB06100M_RT_G
...
#define KGB06100M_RT_G_BUILDER_VERSION_MAJOR  0
#define KGB06100M_RT_G_BUILDER_VERSION_MINOR  10
#define KGB06100M_RT_G_BUILDER_VERSION_BUGFIX 26
#define KGB06100M_RT_G_BUILDER_VERSION_SUFFIX ""
#define KGB06100M_RT_G_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_KGB06100M_RT_G(device_t id)
{
  ...
  feedback_settings.FeedbackType = IMPORTED PROJECT_FEEDBACK_EMF;
  feedback_settings.FeedbackFlags = IMPORTED PROJECT_FEEDBACK_ENC_TYPE_AUTO;
  ...
  home_settings.FastHome = 2745;
  home_settings.uFastHome = 1;
  home_settings.SlowHome = 915;
  home_settings.uSlowHome = 0;
  home_settings.HomeDelta = 389;
  home_settings.uHomeDelta = -29;
  home_settings.HomeFlags = IMPORTED PROJECT_HOME_STOP_SECOND_REV | IMPORTED PROJECT_HOME_STOP_FIRST_BITS | IMPORTED PROJECT_HOME_MV_SEC_EN | IMPORTED PROJECT_HOME_DIR_SECOND;
  ...
  move_settings.Speed = 3675;
  move_settings.uSpeed = 0;
  move_settings.Accel = 4575;
  move_settings.Decel = 9150;
  move_settings.AntiplaySpeed = 49;
  move_settings.uAntiplaySpeed = 100;
  ...
  engine_settings.NomSpeed = 4042;
  engine_settings.uNomSpeed = 128;
  ...
  power_settings.PowerFlags = IMPORTED PROJECT_POWER_REDUCT_ENABLED;
  ...
  secure_settings.CriticalIpwr = 3000;
  ...
  edges_settings.EnderFlags = IMPORTED PROJECT_ENDER_SWAP;
  edges_settings.LeftBorder = -1837;
  edges_settings.uLeftBorder = -128;
  edges_settings.RightBorder = 1838;
  edges_settings.uRightBorder = -128;
  ...
  pid_settings.KpU = 300;
  pid_settings.KiU = 1000;
  pid_settings.KdU = 0;
  pid_settings.Kpf = 0;
  pid_settings.Kif = 0;
  pid_settings.Kdf = 0;
  ...
  sync_in_settings.ClutterTime = 4000;
  sync_in_settings.Position = 0;
  sync_in_settings.uPosition = 0;
  sync_in_settings.Speed = 500;
  sync_in_settings.uSpeed = 128;
  ...
  control_settings.MaxSpeed[0] = 1;
  control_settings.MaxSpeed[1] = 9;
  control_settings.MaxSpeed[2] = 100;
  control_settings.MaxSpeed[3] = 1000;
  control_settings.MaxSpeed[4] = 10001;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {214, 39, 169, 255, 225, 0, 0, 0, 0, 0};
  memcpy(control_settings.uMaxSpeed, control_settings_uMaxSpeed_temp, sizeof(uint8_t) * 10);
  control_settings.Timeout[0] = 200;
  control_settings.Timeout[1] = 500;
  control_settings.Timeout[2] = 800;
  ...
  control_settings.MaxClickTime = 1000;
  control_settings.Flags = IMPORTED PROJECT_CONTROL_MODE_OFF;
  control_settings.DeltaPosition = 10002;
  control_settings.uDeltaPosition = -31;
  ...
  ctp_settings.CTPMinError = 8;
  ctp_settings.CTPFlags = IMPORTED PROJECT_REV_SENS_INV | IMPORTED PROJECT_CTP_ALARM_ON_ERROR;
