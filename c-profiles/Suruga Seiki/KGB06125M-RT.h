#ifndef __KGB06125M_RT
#define __KGB06125M_RT
...
#define KGB06125M_RT_BUILDER_VERSION_MAJOR  0
#define KGB06125M_RT_BUILDER_VERSION_MINOR  10
#define KGB06125M_RT_BUILDER_VERSION_BUGFIX 26
#define KGB06125M_RT_BUILDER_VERSION_SUFFIX ""
#define KGB06125M_RT_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_KGB06125M_RT(device_t id)
{
  ...
  home_settings.FastHome = 2727;
  home_settings.uFastHome = 0;
  home_settings.SlowHome = 909;
  home_settings.uSlowHome = 0;
  home_settings.HomeDelta = 414;
  home_settings.uHomeDelta = 13;
  ...
  move_settings.Speed = 2727;
  move_settings.uSpeed = 0;
  move_settings.Accel = 4545;
  move_settings.Decel = 9090;
  move_settings.AntiplaySpeed = 47;
  move_settings.uAntiplaySpeed = 255;
  ...
  edges_settings.LeftBorder = -1818;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 1818;
  ...
  sync_in_settings.Speed = 503;
  sync_in_settings.uSpeed = 255;
  ...
  control_settings.MaxSpeed[2] = 95;
  control_settings.MaxSpeed[3] = 1007;
  control_settings.MaxSpeed[4] = 10008;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {0, 0, 254, 253, 0, 0, 0, 0, 0, 0};
  ...
  control_settings.DeltaPosition = 10008;
