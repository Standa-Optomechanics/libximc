#ifndef __KGB06125M_RT_G
#define __KGB06125M_RT_G
...
#define KGB06125M_RT_G_BUILDER_VERSION_MAJOR  0
#define KGB06125M_RT_G_BUILDER_VERSION_MINOR  10
#define KGB06125M_RT_G_BUILDER_VERSION_BUGFIX 26
#define KGB06125M_RT_G_BUILDER_VERSION_SUFFIX ""
#define KGB06125M_RT_G_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_KGB06125M_RT_G(device_t id)
{
  ...
  home_settings.HomeDelta = 414;
  home_settings.uHomeDelta = 10;
  ...
  edges_settings.LeftBorder = -1830;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 1830;
  ...
  control_settings.MaxSpeed[3] = 1001;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {212, 38, 166, 3, 221, 0, 0, 0, 0, 0};
  ...
  control_settings.uDeltaPosition = -35;
