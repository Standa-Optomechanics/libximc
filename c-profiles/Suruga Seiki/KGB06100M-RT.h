#ifndef __KGB06100M_RT
#define __KGB06100M_RT
...
#define KGB06100M_RT_BUILDER_VERSION_MAJOR  0
#define KGB06100M_RT_BUILDER_VERSION_MINOR  10
#define KGB06100M_RT_BUILDER_VERSION_BUGFIX 26
#define KGB06100M_RT_BUILDER_VERSION_SUFFIX ""
#define KGB06100M_RT_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_KGB06100M_RT(device_t id)
{
  ...
  home_settings.FastHome = 2737;
  home_settings.uFastHome = 137;
  home_settings.SlowHome = 912;
  home_settings.uSlowHome = 135;
  home_settings.HomeDelta = 389;
  home_settings.uHomeDelta = -51;
  ...
  move_settings.Speed = 3650;
  move_settings.uSpeed = 4;
  move_settings.Accel = 4563;
  move_settings.Decel = 9125;
  move_settings.AntiplaySpeed = 49;
  move_settings.uAntiplaySpeed = 63;
  ...
  engine_settings.NomSpeed = 4015;
  engine_settings.uNomSpeed = 2;
  ...
  edges_settings.LeftBorder = -2007;
  edges_settings.uLeftBorder = -117;
  edges_settings.RightBorder = 1825;
  ...
  control_settings.MaxSpeed[4] = 10002;
  ...
  const uint8_t control_settings_uMaxSpeed_temp[10] = {4, 55, 217, 205, 0, 0, 0, 0, 0, 0};
