#ifndef __PG750M_RA_T_J
#define __PG750M_RA_T_J
...
#define PG750M_RA_T_J_BUILDER_VERSION_MAJOR  0
#define PG750M_RA_T_J_BUILDER_VERSION_MINOR  10
#define PG750M_RA_T_J_BUILDER_VERSION_BUGFIX 26
#define PG750M_RA_T_J_BUILDER_VERSION_SUFFIX ""
#define PG750M_RA_T_J_BUILDER_VERSION        "0.10.26"
...
static inline result_t imported project_set_profile_PG750M_RA_T_J(device_t id)
{
  ...
  edges_settings.LeftBorder = -5000;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 5000;
