...
#define UTS150CC_BUILDER_VERSION_BUGFIX 16
#define UTS150CC_BUILDER_VERSION_SUFFIX ""
#define UTS150CC_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_UTS150CC(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {85, 84, 83, 49, 53, 48, 67, 67, 0, 54, 0, 54, 0, 45, 48, 52, 0, 52, 48, 68, 45, 69, 65, 83};
