...
#define UTS100PPV6_BUILDER_VERSION_BUGFIX 16
#define UTS100PPV6_BUILDER_VERSION_SUFFIX ""
#define UTS100PPV6_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_UTS100PPV6(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {85, 84, 83, 49, 48, 48, 80, 80, 86, 54, 0, 54, 0, 45, 48, 52, 0, 52, 48, 68, 45, 69, 65, 83};
