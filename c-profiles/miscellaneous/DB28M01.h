...
#define DB28M01_BUILDER_VERSION_BUGFIX 16
#define DB28M01_BUILDER_VERSION_SUFFIX ""
#define DB28M01_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_DB28M01(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {68, 66, 50, 56, 77, 48, 49, 0, 49, 55, 53, 0, 69, 110, 49, 0, 95, 52, 48, 68, 45, 69, 65, 83};
