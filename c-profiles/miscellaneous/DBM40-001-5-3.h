...
#define DBM40_001_5_3_BUILDER_VERSION_MINOR  9
#define DBM40_001_5_3_BUILDER_VERSION_BUGFIX 16
#define DBM40_001_5_3_BUILDER_VERSION_SUFFIX ""
#define DBM40_001_5_3_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_DBM40_001_5_3(device_t id)
{
  ...
  engine_settings.Antiplay = 32725;
  ...
  pid_settings.KdU = 0;
  pid_settings.Kpf = 5;
  pid_settings.Kif = 0.0005000000237487257;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {68, 66, 77, 52, 48, 45, 48, 48, 49, 45, 53, 45, 51, 0, 49, 0, 95, 52, 48, 68, 45, 69, 65, 83};
