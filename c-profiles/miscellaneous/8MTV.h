...
#define 8MTV_BUILDER_VERSION_BUGFIX 16
#define 8MTV_BUILDER_VERSION_SUFFIX ""
#define 8MTV_BUILDER_VERSION        "0.9.16"
...
static inline result_t set_profile_8MTV(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 86, 0, 51, 48, 45, 49, 55, 53, 0, 69, 110, 49, 0, 95, 52, 48, 68, 45, 69, 65, 83};
