...
del %EXAMPLES_DIST_DIR%\compiled-win32\test_VBNET.pdb
del %EXAMPLES_DIST_DIR%\compiled-win32\test_VBNET.xml
...
del %EXAMPLES_DIST_DIR%\compiled-win64\test_VBNET.pdb
del %EXAMPLES_DIST_DIR%\compiled-win64\test_VBNET.xml
goto :eof
